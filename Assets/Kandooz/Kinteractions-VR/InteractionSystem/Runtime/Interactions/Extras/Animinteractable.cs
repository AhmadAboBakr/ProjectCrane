...
namespace _2_Kandooz.Kinteractions_VR.InteractionSystem.Runtime.Interactions.Extras
{
    ...
    public class Animinteractable : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            intractable.OnActivated.Do(_ => animator.SetBool(activatedBool, true)).Subscribe().AddTo(this);
            intractable.OnDeactivated.Do(_ => animator.SetBool(activatedBool, false)).Subscribe().AddTo(this);
        }
    }
}